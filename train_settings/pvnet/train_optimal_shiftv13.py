# this version use the "optimal" shift presented by psnet to train a SR net. (0,0) (0,1) (2,2) (3,0), deep_rep
...
def run(settings):
    settings.description = 'fixed pixel shift (0,0) (0,2) (2,3) (2,0)'
