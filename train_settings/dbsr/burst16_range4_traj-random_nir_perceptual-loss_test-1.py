...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic nir dataset, with random pixel shift, range(24), burst size(16), use database function'
