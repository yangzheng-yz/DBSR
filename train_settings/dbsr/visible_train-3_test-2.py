...
def run(settings):
    ...
    nir_visible_train = datasets.nir_visible(burst_sz=settings.burst_sz, split='train-3')
    ...
    data_processing_val = processing.VisibleBurstProcessing(settings.crop_sz,
                                                            ...
                                                            #   burst_transformation_params=burst_transformation_params_val,
                                                              ...
                                                              random_crop=False,
                                                              random_flip=False,
                                                              burst_need_downsample=False)

    # Train sampler and loader
    dataset_train = sampler.RandomImage([nir_visible_train], [1],
                                        samples_per_epoch=settings.batch_size * 10, processing=data_processing_train)
    ...
    net = load_network('/home/yutong/zheng/projects/DBSR/pretrained_networks/pretrained_syn/dbsr_synthetic_default.pth')
