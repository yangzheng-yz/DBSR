...
def run(settings):
    settings.description = 'adjust 4 with pixel step 1/8 LR pixel, discount_factor: 0.99,one_step_length: 1 / 8, iterations: 6, entropy: 0.001'
    ...
    trainer = AgentTrainer(actor, [loader_train, loader_val], optimizer, settings, lr_scheduler=lr_scheduler, 
                               sr_net=dbsr_net, iterations=6, reward_type='psnr',
