...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic burst dataset(NightCity) with step: 4, specific translation(00,01,02,03), crop size: (384, 384) '
