...
def run(settings):
    ...
    weigths_path = "/mnt/7T/zheng/DBSR_results/checkpoints/dbsr/sac_burst5_1step4_multigpu_step7_natural/ActorSAC_0/best_ep0059.pth.tar"
    ...
    permutation = np.array([[0.,0.],[0.,2.],[2.,2.],[2.,0.],[1,1]])
    ...
    trainer = AgentSAC(actors, 
                        ...
                        save_results=True, saving_dir="/mnt/7T/zheng/DBSR_results/loggings/b5_1-4_20231106")
