...
def run(settings):
    ...
    weigths_path = "/mnt/7T/zheng/DBSR_results/checkpoints/dbsr/sac_burst9_1step4_multigpu_step7_natural/ActorSAC_0/best_ep0106.pth.tar"
    ...
    # permutation = np.array([[0.,0.],[0.,2.],[2.,2.],[2.,0.],[3,1],[3,3],[1,1],[0,1],[1,3]]) 
    permutation = np.array([[0.,0.],[0.,2.],[2.,2.],[2.,0.],[3,1],[3,3],[1,0],[1,2],[2,1]])
    ...
    trainer = AgentSAC(actors, 
                        ...
                        save_results=True, saving_dir="/mnt/7T/zheng/DBSR_results/loggings/b9_1-4_20231113_initial1")
