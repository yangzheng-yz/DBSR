...
def run(settings):
    ...
    weigths_path = "/mnt/7T/zheng/DBSR_results/checkpoints/dbsr/sac_burst9_1step4_multigpu_step7_natural/ActorSAC_0/best_ep0050.pth.tar"
    ...
    trainer = AgentSAC(actors, 
                        ...
                        save_results=True, saving_dir="/mnt/7T/zheng/DBSR_results/loggings/b9_1-4_20231106")
