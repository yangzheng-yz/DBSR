# This version try to use loss descent and timestep 10, for debug
...
def run(settings):
    ...
    trainer = SimpleTrainer_v2(actor, [loader_train], optimizer, settings, lr_scheduler=lr_scheduler, 
