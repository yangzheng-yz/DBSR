...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic burst dataset(NightCity) with step: 4, specific translation: 00011110, crop size: (384, 384) '
