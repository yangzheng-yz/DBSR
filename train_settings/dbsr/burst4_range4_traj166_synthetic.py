...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic burst dataset, with specific pixel shift(No.166), range(4), burst size(4), use database function'
