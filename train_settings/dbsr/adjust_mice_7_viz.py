...
def run(settings):
    ...
    trainer = AgentTrainer(actor, [loader_val], optimizer, settings, lr_scheduler=lr_scheduler, 
                               ...
                               save_results=True,
                               saving_dir="/mnt/samsung/zheng_data/training_log/viz_results/adjust_mice_7_viz_val")

    trainer.train(1000, load_latest=False, fail_safe=True, checkpoint="/mnt/samsung/zheng_data/training_log/checkpoints/dbsr/adjust_mice_7/ActorCritic_v2_ep0029.pth.tar") # (epoch, )
