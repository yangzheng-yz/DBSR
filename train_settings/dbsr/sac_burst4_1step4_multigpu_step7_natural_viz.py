...
def run(settings):
    ...
    weigths_path = "/mnt/7T/zheng/DBSR_results/checkpoints/dbsr/before_20231031/sac_burst4_1step4_multigpu_step7_natural/ActorSAC_0/ep0037.pth.tar"
    ...
    trainer = AgentSAC(actors, 
                        ...
                        save_results=True, saving_dir="/mnt/7T/zheng/DBSR_results/loggings/b4_1-4_20231106")
