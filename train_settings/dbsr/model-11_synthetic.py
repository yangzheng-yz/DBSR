...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic burst dataset(NightCity) with step(4), amplify factor(2?), crop size(384, 384), random translation'
    ...
    settings.burst_sz = 4
    settings.downsample_factor = 2 # TODO: need to revise to 4?
