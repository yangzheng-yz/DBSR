...
def run(settings):
    settings.description = 'Default settings for training DBSR models on synthetic burst dataset(NightCity) with step: 8, specific translation(00,01,02,03,10,11,12,13), crop size: (384, 384) '
