...
def run(settings):
    ...
    #                                         'max_scale': 0.0,
    #                                         'border_crop': 24}
    permutation = np.array([[0,0],[0,1],[0,2],[1,0],[1,1],[1,2],[2,0],[2,1]])
    ...
    # 获取encoder部分
    dbsr_net = load_network('/mnt/samsung/zheng_data/training_log/checkpoints/dbsr/deeprep_synthetic_mice_8/DeepRepNet_ep0199.pth.tar')
    ...
    trainer = AgentTrainer(actor, [loader_val], optimizer, settings, lr_scheduler=lr_scheduler, 
                               ...
                               save_results=True,
                               saving_dir="/mnt/samsung/zheng_data/training_log/viz_results/adjust_mice_8_viz_val")

    trainer.train(1000, load_latest=False, fail_safe=True, checkpoint="/mnt/samsung/zheng_data/training_log/checkpoints/dbsr/adjust_mice_8/ActorCritic_v2_ep0033.pth.tar") # (epoch, )
