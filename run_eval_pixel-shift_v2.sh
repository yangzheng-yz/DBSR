...
--ckpt_path /mnt/samsung/zheng/downloaded_datasets/NightCity_1024x512/training_results/checkpoints/dbsr/model-9_synthetic/DBSRNet_ep0100.pth.tar \
...
--save_path /mnt/samsung/zheng/downloaded_datasets/NightCity_1024x512/evaluation_results/model-9_synthetic_Chicago_0006 \
--cfg_file /home/yutong/zheng/projects/DBSR/configs/nightCity_eval.yaml \
--specify_trajetory_num 266 \
--save_results \
