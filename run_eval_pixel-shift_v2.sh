...
--ckpt_path /mnt/samsung/zheng/downloaded_datasets/NightCity_1024x512/training_results/checkpoints/dbsr/model-5_synthetic/DBSRNet_ep0100.pth.tar \
...
--save_path /mnt/samsung/zheng/downloaded_datasets/NightCity_1024x512/evaluation_results/model-5_synthetic \
