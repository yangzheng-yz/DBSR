...
def main():
    image_folder_path = '/mnt/samsung/zheng/downloaded_datasets/NightCity_1024x512/val_dubai-0223'
    val_data_path = image_folder_path
    ...
    for step in np.arange(4,17,4):
        output_step_folder_path = os.path.join(image_folder_path, '..', 'step_%s_dubai-0223_small-shift' % (step))
        ...
        for idx, permutation in enumerate(permutations):       
            ...
            crop_sz = (384 + 24*2, 384 + 24*2) # (384, 384)
            burst_sz = step #TODO: need to specify if want to generate database
            downsample_factor = 4

            burst_transformation_params = {'max_translation': 4.0,
                                        'max_rotation': 0.0,
                                        'max_shear': 0.0,
                                        'max_scale': 0.0,
                                        'border_crop': 24,
