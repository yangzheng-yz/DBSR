...
class nir_synthetic(BaseImageDataset):
    """
    ...
    def __init__(self, root=None, split='train', image_loader=opencv_loader, initialize=True):
        ...
        """
        root = env_settings().nir_synthetic_dir if root is None else root
        super().__init__('nir_synthetic', root, image_loader)
        self.split = split
    ...
    def _get_image(self, im_id):
        ...
        return img # return rgb channels
