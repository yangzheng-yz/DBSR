...
def compute_score(setting_name, load_saved=False, burst_size=14, dataset_root=""):
    ...
    dataset = SyntheticBurstVal(root=dataset_root, burst_size=burst_size)
    ...
    for n in network_list:
        ...
        for idx in tqdm.tqdm(range(len(dataset))):
            ...
            if n.burst_sz is not None: # default is none
                # print("I am here!!!!")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, default="", help='Name of experiment setting')
    parser.add_argument('--burst_size', type=int, default=14, help='Name of experiment setting')
    parser.add_argument('--load_saved', dest='load_saved', action='store_true', default=False)

    args = parser.parse_args()
    

    compute_score(args.setting, args.load_saved, burst_size=args.burst_size, dataset_root=args.dataset_root)